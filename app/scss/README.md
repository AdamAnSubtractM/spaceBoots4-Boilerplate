...
The `scss/` directory contains three folders: Base, UI, Vendor, and Sites-base.
...
- **Sites-base** contains DSG's, Golf Galaxy's, and Field and Stream's base styles. Import them at the bottom of `_manifest.scss` file to match your local build with the live site.
